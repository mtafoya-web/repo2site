...
import {
  useRepo2SiteBuilderSpriteController,
  type BuilderSpriteReactionSignal,
  type BuilderSpriteReactionType,
} from "@/hooks/use-repo2site-builder-sprite-controller";
import type { PreviewTheme } from "@/lib/types";

export type { BuilderSpriteReactionSignal, BuilderSpriteReactionType };
...
export function Repo2SiteBuilderSprite({
  ...
  const {
    ...
    offset,
    shellShadow,
  } = useRepo2SiteBuilderSpriteController({ enabled, palette, reaction });
